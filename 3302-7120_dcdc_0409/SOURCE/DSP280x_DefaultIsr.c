...
interrupt void NMI_ISR(void)       // Non-maskable interrupt
{
	...
	EPwm3Regs.AQCSFRC.all = 0x5;		//PWM3A,PWM3B force low
	EPwm4Regs.AQCSFRC.all = 0x5;		//PWM4A,PWM4B force low
	for(;;);
}
...
/*interrupt void USER_ISR(void)     // User Defined trap 1
{
	// Insert ISR Code here
...
{
	EPwm1Regs.AQCSFRC.all = 0x5;		//PWM1A force low
	EPwm2Regs.AQCSFRC.all = 0x5;		//PWM2A force low
	EPwm3Regs.AQCSFRC.all = 0x5;		//PWM3A force low
	EPwm4Regs.AQCSFRC.all = 0x5;		//PWM4A force low
	for(;;);
}
//===========================================================================
// End of file.
