...
//----------------------------------------
#ifdef __cplusplus 
#pragma DATA_SECTION("DcdcisrFile") 
#else
#pragma DATA_SECTION(Dcdcisr,"DcdcisrFile");
#endif
volatile struct dcdc_100a_isr Dcdcisr;

//----------------------------------------
/*#ifdef __cplusplus 
#pragma DATA_SECTION("BootVariableFile") 
#else
#pragma DATA_SECTION(BootVars,"BootVariableFile");
#endif
volatile struct BootVarsStruct BootVars;*/
